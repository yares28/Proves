    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/exams/**").hasAnyRole("USER", "AUTHENTICATED", "SERVICE")
                        .requestMatchers(HttpMethod.POST, "/api/exams/**").hasAnyRole("AUTHENTICATED", "SERVICE")
                        .requestMatchers(HttpMethod.PUT, "/api/exams/**").hasAnyRole("AUTHENTICATED", "SERVICE")
                        .requestMatchers(HttpMethod.DELETE, "/api/exams/**").hasAnyRole("SERVICE")
